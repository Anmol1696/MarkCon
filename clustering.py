...
list_address = ["andheri", "jvlr", "lokhandwala", "oshiwara", "vile parle", "malad", "goregaon", "kandivali", "borivali", "bandra", "sion", "santacruz", \
				...
				"churchgate", "nariman point", "cuffe parade", "thane", "breach candy", "malabar hill", "grant road", "charni road", "dockyard", "mazgaon"]
				# , "any sort of Sector implies navi mumbai"
name_address = ['C','C','C','C','C','A','A','A','A','B','D','D','D','I','I','I','E','E','E','E','E','F','F','F','H','H','H','H','J','G','G','G','G','L','L']
