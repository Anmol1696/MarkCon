...
def single_profile(url, driver):
	...
	person = Info(url)
	person.name = getting_name(driver)
	person.sex = getting_sex(driver)
	person.lives = getting_lives(driver)
	person.job = getting_job_education(driver, 'job')
	person.education = getting_job_education(driver, 'education')
